...
-------------------------
WSGIPythonPath /var/www/vhosts/netzsprung.de
WSGIScriptAlias / /var/www/vhosts/netzsprung.de/DjangoHuenni-Blog/wsgi.py
    
<VirtualHost netzsrpung.de:80>

WSGIPythonPath /var/www/vhosts/netzsprung.de/httpdocs
WSGIScriptAlias /httpdocs/ /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni-Blog/wsgi.py
WSGIPythonHome /var/www/vhosts/netzsprung.de/httpdocs/.env




    DocumentRoot /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni-Blog
    ServerName netzsprung.de
    <Directory "/var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni-Blog">
        Options None
        Require all granted
    </Directory>
    WSGIDaemonProcess netzsprung.de python-path=/var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni-Blog  python-home=/var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni-Blog/.env
    WSGIProcessGroup netzsprung.de
    HostNameLookups off
    Alias /static/ /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni-Blog/static/
...
WSGIPythonPath /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog
WSGIScriptAlias / /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog/wsgi.py
WSGIPythonHome /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog/.env




    DocumentRoot /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog
    ServerName netzsprung.de
    <Directory "/var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog">
        Options None
        Require all granted
    </Directory>
    WSGIDaemonProcess netzsprung.de python-path=/var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog  python-home=/var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog/.env
    WSGIProcessGroup netzsprung.de
    HostNameLookups off
    Alias /static/ /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog/static/

_____________________
DocumentRoot /var/www/vhosts/netzsprung.de/httpdocs/

ServerName netzsprung.de
<Directory "/var/www/vhosts/netzsprung.de/httpdocs/">
	Options None
	Require all granted
</Directory>
# WSGIDaemonProcess netzsprung.de python-path=/var/www/vhosts/netzsprung.de/httpdocs/.env/lib/python3.12/site-packages  python-home=/var/www/vhosts/netzsprung.de/httpdocs/.env
WSGIDaemonProcess netzsprung.de python-path=/var/www/vhosts/netzsprung.de/httpdocs  python-home=/var/www/vhosts/netzsprung.de/httpdocs/.env
WSGIProcessGroup netzsprung.de
HostNameLookups off
Alias /static/ /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog/static/

WSGIScriptAlias / /var/www/vhosts/netzsprung.de/httpdocs/DjangoHuenni_Blog/wsgi.py process-group=netzsprung.de
